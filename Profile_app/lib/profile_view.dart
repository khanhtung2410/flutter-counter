...
import 'package:my_app/location/address_info.dart';
import 'package:my_app/location/district.dart';
import 'package:my_app/location/province.dart';
import 'package:my_app/location/ward.dart';
...
class Step1Form extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _Step1FormState();
}
          ...
          TextFormField(
            ...
            validator: (value) {
              if (value == null || value.isEmpty) {
                ...
                return 'Định dạng emaail không hợp lệ';
              }
              return null;
            },
          ...
          children: [
            ...
            Autocomplete<District>(
              fieldViewBuilder: (context, textEditingController, focusNode,
                ...
                return TextFormField(
                  decoration: const InputDecoration(labelText: 'Huyện / Quận'),
                  controller: textEditingController,
                  focusNode: focusNode,
                  validator: (value) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoItem('Xã / Phường / Trấn:', userInfo.address?.ward?.name),
